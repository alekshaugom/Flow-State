...
export const RESERVOIRS = [
	{ id: 'blue-mesa', name: 'Blue Mesa Reservoir', riverId: 'gunnison', operator: 'Bureau of Reclamation', latitude: 38.458, longitude: -107.324, maxStorageAcreFt: 829500, normalElevationFt: 7519.4, sourceId: '1533', source: 'bor-rise', url: 'https://data.usbr.gov/', notes: 'Largest reservoir in Colorado. Part of Aspinall Unit. Controls Gunnison River flows downstream through Morrow Point and Crystal.', diversionName: 'Gunnison Tunnel', diversionGaugeId: 'usgs-09128000', plannedReleaseUrl: 'https://www.usbr.gov/uc/wcao/water/rsvrs/notice/asp_rel.html', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	...
	{ id: 'turquoise-lake', name: 'Turquoise Lake', riverId: 'arkansas', operator: 'Bureau of Reclamation', latitude: 39.261, longitude: -106.386, maxStorageAcreFt: 129440, normalElevationFt: 9868, sourceId: '498', source: 'bor-rise', url: 'https://data.usbr.gov/', notes: 'Fryingpan-Arkansas terminal reservoir near Leadville. Receives transmountain diversions. Releases into Lake Fork Arkansas and into Arkansas via pipeline.', plannedReleaseUrl: 'https://www.usbr.gov/gp/ecao/', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
