...
export const CORRIDORS = [
	// === Arkansas ===
	{ id: 'arkansas-headwaters', watershedId: 'arkansas', riverId: 'arkansas', name: 'Arkansas Headwaters', shortName: 'Arkansas Headwaters', description: 'The signature Colorado rafting corridor: Numbers, Fractions, Browns Canyon, Bighorn Sheep, and Royal Gorge between Leadville and Canon City. Managed as the Arkansas Headwaters Recreation Area.', summaryMd: '', summaryUpdatedAt: '', geometryJson: '', governingReservoirIds: 'twin-lakes,turquoise-lake,clear-creek-reservoir', primaryGaugeId: 'usgs-07091200', driver: 'snowmelt', sortIndex: 10 },
	...
	{ id: 'south-platte-corridor', watershedId: 'south-platte', riverId: 'south-platte', name: 'South Platte Corridor', shortName: 'South Platte', description: 'South Platte canyons closest to Denver: Waterton (hike-in) and Deckers below Cheesman Reservoir.', summaryMd: '', summaryUpdatedAt: '', geometryJson: '', governingReservoirIds: 'cheesman,strontia,chatfield', primaryGaugeId: 'usgs-06710247', driver: 'snowmelt', sortIndex: 10 },
	...
	// === Yampa ===
	{ id: 'yampa-corridor', watershedId: 'yampa-green', riverId: 'yampa', name: 'Yampa Corridor', shortName: 'Yampa', description: 'Cross Mountain Gorge and the Dinosaur National Monument wilderness multi-day. Free-flowing — NPS permits required for Dinosaur.', summaryMd: '', summaryUpdatedAt: '', geometryJson: '', governingReservoirIds: 'stagecoach,elkhead', primaryGaugeId: 'usgs-09260050', driver: 'snowmelt', sortIndex: 10 },
...
export const SECTIONS = [
	// === COLORADO RIVER ===
	{ id: 'colorado-pumphouse', riverId: 'colorado', corridorId: 'upper-colorado', driver: 'snowmelt', sortIndex: 20, name: 'Pumphouse to State Bridge', putIn: 'Pumphouse Recreation Site', takeOut: 'State Bridge', difficultyMin: 'II', difficultyMax: 'III', lengthMiles: 14, flowLow: 400, flowRunnable: 600, flowIdealMin: 800, flowIdealMax: 2500, flowHigh: 4000, flowExpert: 5500, flowDangerous: 8000, primaryGaugeId: 'usgs-09058000', upstreamGaugeIds: '', downstreamGaugeIds: 'usgs-09060799', reservoirIds: 'granby,williams-fork,wolford-mountain,green-mountain', snowpackBasinIds: 'upper-colorado-headwaters', notes: 'Most popular intermediate run on the upper Colorado. Class II-III rapids with one Class III (Eye of the Needle). Put-in at Pumphouse BLM site.', latitude: 39.987, longitude: -106.534 },
	{ id: 'colorado-gore-canyon', riverId: 'colorado', corridorId: 'upper-colorado', driver: 'snowmelt', sortIndex: 10, name: 'Gore Canyon', putIn: 'Pumphouse/Gore Canyon trailhead', takeOut: 'Below Gore Canyon', difficultyMin: 'IV', difficultyMax: 'V', lengthMiles: 5, flowLow: 500, flowRunnable: 700, flowIdealMin: 800, flowIdealMax: 1800, flowHigh: 2500, flowExpert: 3500, flowDangerous: 5000, primaryGaugeId: 'usgs-09058000', upstreamGaugeIds: '', downstreamGaugeIds: 'usgs-09060799', reservoirIds: 'granby,williams-fork,wolford-mountain,green-mountain', snowpackBasinIds: 'upper-colorado-headwaters', notes: 'Expert-only Class IV-V canyon with mandatory portages at some levels. Remote with difficult access. Train tracks alongside. Scouting required.', latitude: 39.951, longitude: -106.502 },
	{ id: 'colorado-shoshone', riverId: 'colorado', corridorId: 'glenwood-canyon', driver: 'snowmelt', sortIndex: 10, name: 'Shoshone / Glenwood Canyon', putIn: 'Shoshone Power Plant', takeOut: 'Grizzly Creek or No Name', difficultyMin: 'III', difficultyMax: 'IV', lengthMiles: 5, flowLow: 1500, flowRunnable: 2000, flowIdealMin: 3000, flowIdealMax: 8000, flowHigh: 12000, flowExpert: 16000, flowDangerous: 20000, primaryGaugeId: 'usgs-09070500', upstreamGaugeIds: 'usgs-09058000,usgs-09060799', downstreamGaugeIds: '', reservoirIds: 'granby,williams-fork,wolford-mountain,green-mountain', snowpackBasinIds: 'upper-colorado-headwaters,eagle-river,roaring-fork', notes: 'High-volume Class III-IV through Glenwood Canyon along I-70. Shoshone rapids are the signature whitewater. Minimum flow maintained by Shoshone hydropower diversion rights.', latitude: 39.567, longitude: -107.239 },
	{ id: 'colorado-south-canyon', riverId: 'colorado', corridorId: 'grand-valley', driver: 'snowmelt', sortIndex: 10, name: 'South Canyon to New Castle', putIn: 'South Canyon', takeOut: 'New Castle', difficultyMin: 'II', difficultyMax: 'III', lengthMiles: 8, flowLow: 2000, flowRunnable: 3000, flowIdealMin: 4000, flowIdealMax: 12000, flowHigh: 18000, flowExpert: 22000, flowDangerous: 28000, primaryGaugeId: 'usgs-09085000', upstreamGaugeIds: 'usgs-09070500', downstreamGaugeIds: 'usgs-09095500', reservoirIds: 'granby,williams-fork,wolford-mountain,green-mountain,ruedi', snowpackBasinIds: 'upper-colorado-headwaters,roaring-fork', notes: 'Wide, high-volume Class II-III below Glenwood Springs. Good for families and beginners at moderate flows.', latitude: 39.556, longitude: -107.374 },
	{ id: 'colorado-ruby-horsethief', riverId: 'colorado', corridorId: 'ruby-horsethief', driver: 'snowmelt', sortIndex: 10, name: 'Ruby-Horsethief Canyon', putIn: 'Loma boat launch', takeOut: 'Westwater Ranger Station (Utah)', difficultyMin: 'I', difficultyMax: 'II', lengthMiles: 25, flowLow: 1500, flowRunnable: 2000, flowIdealMin: 3000, flowIdealMax: 15000, flowHigh: 25000, flowExpert: 35000, flowDangerous: 45000, primaryGaugeId: 'usgs-09163500', upstreamGaugeIds: 'usgs-09095500', downstreamGaugeIds: '', reservoirIds: 'granby,williams-fork,wolford-mountain,green-mountain,ruedi,crystal-dam', snowpackBasinIds: 'upper-colorado-headwaters,gunnison-river', notes: 'Scenic flatwater through red-rock canyons near the Colorado-Utah border. Popular 2-3 day canoe/kayak/raft trip. BLM managed. Permit not required but group size limits apply.', latitude: 39.060, longitude: -108.810 },
	{ id: 'colorado-cameo-to-palisade', riverId: 'colorado', corridorId: 'grand-valley', driver: 'snowmelt', sortIndex: 20, name: 'Cameo to Palisade', putIn: 'Cameo', takeOut: 'Palisade', difficultyMin: 'II', difficultyMax: 'III', lengthMiles: 10, flowLow: 2000, flowRunnable: 3000, flowIdealMin: 5000, flowIdealMax: 15000, flowHigh: 20000, flowExpert: 28000, flowDangerous: 35000, primaryGaugeId: 'usgs-09095500', upstreamGaugeIds: 'usgs-09085000', downstreamGaugeIds: 'usgs-09163500', reservoirIds: 'granby,williams-fork,wolford-mountain,green-mountain,ruedi', snowpackBasinIds: 'upper-colorado-headwaters,gunnison-river', notes: 'High-volume Class II-III near Grand Junction. De Beque Canyon section upstream is more remote.', latitude: 39.189, longitude: -108.312 },

	// === ARKANSAS RIVER ===
	{ id: 'arkansas-numbers', riverId: 'arkansas', corridorId: 'arkansas-headwaters', driver: 'reservoir-release', sortIndex: 10, name: 'The Numbers', putIn: 'Numbers Launch', takeOut: 'Railroad Bridge', difficultyMin: 'IV', difficultyMax: 'V', lengthMiles: 5.96, flowLow: 300, flowRunnable: 500, flowIdealMin: 700, flowIdealMax: 1800, flowHigh: 2500, flowExpert: 3500, flowDangerous: 5000, primaryGaugeId: 'usgs-07087050', upstreamGaugeIds: '', downstreamGaugeIds: 'usgs-07091200', reservoirIds: 'twin-lakes,turquoise-lake,clear-creek-reservoir', snowpackBasinIds: 'arkansas-headwaters', notes: 'Named for numbered mile markers. Steep, continuous Class IV-V whitewater. Commercial trips run at lower flows; expert kayaking at higher flows. Fryingpan-Ark Project releases from Twin Lakes and Turquoise Lake affect flows.', latitude: 38.849, longitude: -106.289 },
	{ id: 'arkansas-fractions', riverId: 'arkansas', corridorId: 'arkansas-headwaters', driver: 'snowmelt', sortIndex: 15, name: 'The Fractions', putIn: 'Railroad Bridge', takeOut: 'Buena Vista', difficultyMin: 'III', difficultyMax: 'III+', lengthMiles: 6.53, flowLow: 300, flowRunnable: 400, flowIdealMin: 600, flowIdealMax: 2000, flowHigh: 3000, flowExpert: 4000, flowDangerous: 5500, primaryGaugeId: 'usgs-07091200', upstreamGaugeIds: 'usgs-07087050', downstreamGaugeIds: '', reservoirIds: 'twin-lakes,turquoise-lake,clear-creek-reservoir', snowpackBasinIds: 'arkansas-headwaters', notes: 'Class III between Numbers and Browns Canyon. Good intermediate section. Named because rapids are between the Numbers and Browns.', latitude: 38.777, longitude: -106.170 },

	{ id: 'arkansas-bighorn-sheep-upper', riverId: 'arkansas', corridorId: 'arkansas-headwaters', driver: 'snowmelt', sortIndex: 37, name: 'Upper Bighorn Sheep Canyon', shortName: 'Upper Bighorn Sheep', description: 'Class II-III flatwater from Salida East down through the upper canyon to Cotopaxi, where the canyon proper begins.', putIn: 'Salida East', takeOut: 'Cotopaxi', difficultyMin: 'II', difficultyMax: 'III', lengthMiles: 23.11, flowLow: 300, flowRunnable: 500, flowIdealMin: 700, flowIdealMax: 2500, flowHigh: 3500, flowExpert: 4500, flowDangerous: 6000, primaryGaugeId: 'usgs-07091200', upstreamGaugeIds: 'usgs-07091200', downstreamGaugeIds: 'usgs-07094500', reservoirIds: 'twin-lakes,turquoise-lake,clear-creek-reservoir', snowpackBasinIds: 'arkansas-headwaters', notes: 'Mostly flatwater between Salida and Cotopaxi following US-50 east. Class II-III with several AHRA access sites (Point Barr, Rincon, Vallie Bridge, Trading Post). Canyon scenery picks up below Trading Post.', latitude: 38.45, longitude: -105.80 },
	{ id: 'arkansas-bighorn-sheep', riverId: 'arkansas', corridorId: 'arkansas-headwaters', driver: 'snowmelt', sortIndex: 40, name: 'Lower Bighorn Sheep Canyon', shortName: 'Lower Bighorn Sheep', putIn: 'Cotopaxi', takeOut: 'Parkdale', difficultyMin: 'III', difficultyMax: 'IV', lengthMiles: 21.17, flowLow: 300, flowRunnable: 500, flowIdealMin: 600, flowIdealMax: 3000, flowHigh: 4000, flowExpert: 5000, flowDangerous: 7000, primaryGaugeId: 'usgs-07094500', upstreamGaugeIds: 'usgs-07091200', downstreamGaugeIds: '', reservoirIds: 'twin-lakes,turquoise-lake,clear-creek-reservoir', snowpackBasinIds: 'arkansas-headwaters', notes: 'Class III-IV through the canyon proper from Cotopaxi to Parkdale. Scenic AHRA stretch with bighorn sheep watchable wildlife area at Five Points.', latitude: 38.43, longitude: -105.55 },
	{ id: 'arkansas-royal-gorge', riverId: 'arkansas', corridorId: 'arkansas-headwaters', driver: 'snowmelt', sortIndex: 50, name: 'Royal Gorge', putIn: 'Parkdale', takeOut: 'Canon City', difficultyMin: 'IV', difficultyMax: 'V', lengthMiles: 10, flowLow: 400, flowRunnable: 600, flowIdealMin: 800, flowIdealMax: 2500, flowHigh: 3500, flowExpert: 4500, flowDangerous: 6000, primaryGaugeId: 'usgs-07094500', upstreamGaugeIds: 'usgs-07091200', downstreamGaugeIds: '', reservoirIds: 'twin-lakes,turquoise-lake,clear-creek-reservoir', snowpackBasinIds: 'arkansas-headwaters', notes: 'Iconic deep canyon with Class IV-V rapids. Sunshine Falls (Class V) is the crux. Walls rise 1,000+ feet. Commercial and private trips. Below 600 CFS becomes technical Class IV.', latitude: 38.462, longitude: -105.328 },
	...
	{ id: 'arkansas-pine-creek', riverId: 'arkansas', corridorId: 'arkansas-headwaters', driver: 'reservoir-release', sortIndex: 5, name: 'Pine Creek', putIn: 'Granite', takeOut: 'Numbers Launch', difficultyMin: 'V', difficultyMax: 'V+', lengthMiles: 5.15, flowLow: 300, flowRunnable: 500, flowIdealMin: 700, flowIdealMax: 1500, flowHigh: 2200, flowExpert: 3000, flowDangerous: 4500, primaryGaugeId: 'usgs-07087050', upstreamGaugeIds: '', downstreamGaugeIds: 'usgs-07087050', reservoirIds: 'twin-lakes,turquoise-lake,clear-creek-reservoir', snowpackBasinIds: 'arkansas-headwaters', notes: 'Class V Pine Creek Rapid sits at the top of the Numbers run. Most parties portage at the AHRA Pine Creek Recreation Site; experts who run it use the Granite put-in. Short, intense, no rescue eddy below the drop.', latitude: 39.03, longitude: -106.26 },
	{ id: 'arkansas-town-boat-chute', riverId: 'arkansas', corridorId: 'arkansas-headwaters', driver: 'snowmelt', sortIndex: 20, name: 'Town / Boat Chute', putIn: 'Buena Vista', takeOut: 'Johnson\'s Village', difficultyMin: 'II', difficultyMax: 'III', lengthMiles: 1.56, flowLow: 250, flowRunnable: 400, flowIdealMin: 600, flowIdealMax: 1800, flowHigh: 2800, flowExpert: 3800, flowDangerous: 5000, primaryGaugeId: 'usgs-07091200', upstreamGaugeIds: 'usgs-07087050', downstreamGaugeIds: '', reservoirIds: 'twin-lakes,turquoise-lake,clear-creek-reservoir', snowpackBasinIds: 'arkansas-headwaters', notes: 'Class II-III town stretch above and through Buena Vista, including Boat Chute Rapid and the BV whitewater park play features. Family-friendly at moderate flows; gets pushy above ~2000 cfs.', latitude: 38.86, longitude: -106.14 },
	{ id: 'arkansas-milk-run', riverId: 'arkansas', corridorId: 'arkansas-headwaters', driver: 'snowmelt', sortIndex: 25, name: 'Milk Run', putIn: 'Johnson\'s Village', takeOut: 'Ruby Mountain', difficultyMin: 'II', difficultyMax: 'III', lengthMiles: 6.99, flowLow: 300, flowRunnable: 400, flowIdealMin: 600, flowIdealMax: 2000, flowHigh: 3000, flowExpert: 4000, flowDangerous: 5500, primaryGaugeId: 'usgs-07091200', upstreamGaugeIds: '', downstreamGaugeIds: 'usgs-07094500', reservoirIds: 'twin-lakes,turquoise-lake,clear-creek-reservoir', snowpackBasinIds: 'arkansas-headwaters', notes: 'Mellow Class II-III link between the Fractions take-out and Browns Canyon put-in. Common guide training / warm-up float. Upper/Lower split deferred until a curated intermediate access point is added.', latitude: 38.74, longitude: -106.10 },
	{ id: 'arkansas-browns-upper', riverId: 'arkansas', corridorId: 'arkansas-headwaters', driver: 'snowmelt', sortIndex: 31, name: 'Upper Browns', putIn: 'Ruby Mountain', takeOut: 'Hecla Junction', difficultyMin: 'III', difficultyMax: 'IV', lengthMiles: 5, flowLow: 300, flowRunnable: 500, flowIdealMin: 700, flowIdealMax: 2500, flowHigh: 3500, flowExpert: 4500, flowDangerous: 6000, primaryGaugeId: 'usgs-07091200', upstreamGaugeIds: 'usgs-07087050', downstreamGaugeIds: 'usgs-07094500', reservoirIds: 'twin-lakes,turquoise-lake,clear-creek-reservoir', snowpackBasinIds: 'arkansas-headwaters', notes: 'Upper Browns: Ruby Mountain (private boaters preferred) or Fisherman\'s Bridge (commercial) down to Hecla Junction. Includes Zoom Flume, Pinball, and Seidel\'s Suckhole. Note: Fisherman\'s Bridge is at river mile 24.5 — geographically inside the Milk Run section — but most commercial outfitters use it as the de-facto Upper Browns put-in to access the full canyon.', latitude: 38.71, longitude: -106.085 },
	{ id: 'arkansas-browns-lower', riverId: 'arkansas', corridorId: 'arkansas-headwaters', driver: 'snowmelt', sortIndex: 32, name: 'Lower Browns', putIn: 'Hecla Junction', takeOut: 'Stone Bridge', difficultyMin: 'III', difficultyMax: 'III+', lengthMiles: 4, flowLow: 300, flowRunnable: 500, flowIdealMin: 700, flowIdealMax: 2500, flowHigh: 3500, flowExpert: 4500, flowDangerous: 6000, primaryGaugeId: 'usgs-07091200', upstreamGaugeIds: 'usgs-07087050', downstreamGaugeIds: 'usgs-07094500', reservoirIds: 'twin-lakes,turquoise-lake,clear-creek-reservoir', snowpackBasinIds: 'arkansas-headwaters', notes: 'Lower Browns: Hecla Junction down through Staircase to Stone Bridge.', latitude: 38.66, longitude: -106.05 },
	{ id: 'arkansas-big-bend', riverId: 'arkansas', corridorId: 'arkansas-headwaters', driver: 'snowmelt', sortIndex: 35, name: 'Big Bend', putIn: 'Stone Bridge', takeOut: 'Salida East', difficultyMin: 'II', difficultyMax: 'III', lengthMiles: 11.42, flowLow: 300, flowRunnable: 500, flowIdealMin: 700, flowIdealMax: 2500, flowHigh: 3500, flowExpert: 4500, flowDangerous: 6000, primaryGaugeId: 'usgs-07091200', upstreamGaugeIds: '', downstreamGaugeIds: 'usgs-07094500', reservoirIds: 'twin-lakes,turquoise-lake,clear-creek-reservoir', snowpackBasinIds: 'arkansas-headwaters', notes: 'Class II-III flatwater stretch from Stone Bridge through Salida ending at the Salida East AHRA campground. Most boaters break this into shorter day runs.', latitude: 38.55, longitude: -106.00 },
	{ id: 'arkansas-canon-to-reservoir', riverId: 'arkansas', corridorId: 'arkansas-headwaters', driver: 'snowmelt', sortIndex: 60, name: 'Cañon City to Pueblo Reservoir', putIn: 'Centennial Park', takeOut: 'Pueblo Reservoir Inlet (West)', difficultyMin: 'I', difficultyMax: 'II', lengthMiles: 33, flowLow: 200, flowRunnable: 300, flowIdealMin: 500, flowIdealMax: 2500, flowHigh: 4000, flowExpert: 5000, flowDangerous: 7000, primaryGaugeId: 'usgs-07094500', upstreamGaugeIds: '', downstreamGaugeIds: '', reservoirIds: 'twin-lakes,turquoise-lake,clear-creek-reservoir', snowpackBasinIds: 'arkansas-headwaters', notes: 'Flatwater drift between the bottom of Royal Gorge and the head of Lake Pueblo. Class I-II throughout; primarily fishing, family floats, and overnight-camping use. The take-out is the last practical river access before the impassable Pueblo Dam.', latitude: 38.40, longitude: -104.95 },

	// === ARKANSAS — Pueblo Plains (below Pueblo Dam) ===
	{ id: 'arkansas-pueblo-mup', riverId: 'arkansas', corridorId: 'arkansas-pueblo-plains', driver: 'reservoir-release', sortIndex: 10, name: 'Pueblo MUP & Whitewater Park', putIn: 'Pueblo MUP put-in', takeOut: 'Pueblo Whitewater Park', difficultyMin: 'I', difficultyMax: 'II+', lengthMiles: 5, flowLow: 100, flowRunnable: 200, flowIdealMin: 400, flowIdealMax: 1500, flowHigh: 2500, flowExpert: 3500, flowDangerous: 5000, primaryGaugeId: 'usgs-07099970', upstreamGaugeIds: '', downstreamGaugeIds: '', reservoirIds: 'pueblo', controllingReservoirId: 'pueblo', snowpackBasinIds: '', notes: 'Resumes the Arkansas River corridor below the impassable Pueblo Dam. Class I-II float along the Arkansas River MUP through Pueblo, with the Pueblo Whitewater Park play features (Tom Glasgow Boat Ramp at Moffat Street). Flow is fully controlled by Pueblo Dam releases.', latitude: 38.265, longitude: -104.640 },
	...
	{ id: 'south-platte-denver', riverId: 'south-platte', corridorId: 'south-platte-corridor', driver: 'snowmelt', sortIndex: 25, name: 'Waterton to Brighton', putIn: 'Waterton Canyon Trailhead', takeOut: 'Brighton (Bromley Lane)', difficultyMin: 'I', difficultyMax: 'II', lengthMiles: 44, flowLow: 200, flowRunnable: 400, flowIdealMin: 600, flowIdealMax: 2500, flowHigh: 4000, flowExpert: 5500, flowDangerous: 8000, primaryGaugeId: 'usgs-06710247', upstreamGaugeIds: '', downstreamGaugeIds: '', reservoirIds: 'chatfield,strontia', snowpackBasinIds: 'south-platte-headwaters', notes: 'Urban Class I-II drift through Chatfield SP, the C-470 put-in, River Run Park, Confluence Park, and the Globeville/Brighton stretch.', latitude: 39.7, longitude: -105 },
	// Phase 5b — final orphan coverage
	{ id: 'colorado-new-castle-to-cameo', riverId: 'colorado', corridorId: 'grand-valley', driver: 'snowmelt', sortIndex: 50, name: 'New Castle to Cameo', putIn: 'New Castle Boat Ramp', takeOut: 'Cameo Boat Ramp', difficultyMin: 'I', difficultyMax: 'II', lengthMiles: 56, flowLow: 800, flowRunnable: 1500, flowIdealMin: 2000, flowIdealMax: 6000, flowHigh: 9000, flowExpert: 12000, flowDangerous: 18000, primaryGaugeId: 'usgs-09095500', upstreamGaugeIds: 'usgs-09085100', downstreamGaugeIds: '', reservoirIds: 'granby,williams-fork,wolford-mountain,green-mountain,ruedi', snowpackBasinIds: 'upper-colorado-headwaters', notes: 'Class I-II flatwater past Silt, Rifle, and DeBeque Canyon. Wide-river family-floating reach.', latitude: 39.55, longitude: -107.95 },
	{ id: 'colorado-palisade-to-corn-lake', riverId: 'colorado', corridorId: 'grand-valley', driver: 'snowmelt', sortIndex: 70, name: 'Palisade to Corn Lake', putIn: 'Riverbend Park (Palisade)', takeOut: 'Corn Lake (James M. Robb State Park)', difficultyMin: 'I', difficultyMax: 'II', lengthMiles: 8, flowLow: 800, flowRunnable: 1500, flowIdealMin: 2000, flowIdealMax: 6000, flowHigh: 9000, flowExpert: 12000, flowDangerous: 18000, primaryGaugeId: 'usgs-09095500', upstreamGaugeIds: '', downstreamGaugeIds: '', reservoirIds: 'granby,williams-fork,wolford-mountain,green-mountain,ruedi', snowpackBasinIds: 'upper-colorado-headwaters', notes: 'Short Class I-II float through Clifton.', latitude: 39.08, longitude: -108.45 },
...
export const GAUGES = [
	...
	{ id: 'cdss-CLAFTCCO', name: 'Cache la Poudre at Canyon Mouth near Fort Collins', source: 'cdss', sourceId: 'CLAFTCCO', riverId: 'cache-la-poudre', corridorId: 'poudre-canyon', latitude: 40.66451, longitude: -105.224188, parameter: 'discharge', unit: 'cfs', url: 'https://dwr.state.co.us/tools/stations/CLAFTCCO', active: true },
...
export const RESERVOIRS = [
	{ id: 'blue-mesa', name: 'Blue Mesa Reservoir', riverId: 'gunnison', feedsReservoirId: 'morrow-point', operator: 'Bureau of Reclamation', latitude: 38.458, longitude: -107.324, maxStorageAcreFt: 829500, normalElevationFt: 7519.4, sourceId: '1533', source: 'bor-rise', url: 'https://data.usbr.gov/', notes: 'Largest reservoir in Colorado. Part of Aspinall Unit. Controls Gunnison River flows downstream through Morrow Point and Crystal.', diversionName: 'Gunnison Tunnel', diversionGaugeId: 'usgs-09128000', plannedReleaseUrl: 'https://www.usbr.gov/uc/wcao/water/rsvrs/notice/asp_rel.html', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'morrow-point', name: 'Morrow Point Reservoir', riverId: 'gunnison', feedsReservoirId: 'crystal-dam', operator: 'Bureau of Reclamation', latitude: 38.451, longitude: -107.534, maxStorageAcreFt: 117190, normalElevationFt: 7160, sourceId: '417', source: 'bor-rise', url: 'https://data.usbr.gov/', notes: 'Middle reservoir of Aspinall Unit in Black Canyon. Hydroelectric generation.', diversionName: 'Gunnison Tunnel', diversionGaugeId: 'usgs-09128000', plannedReleaseUrl: 'https://www.usbr.gov/uc/wcao/water/rsvrs/notice/asp_rel.html', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'crystal-dam', name: 'Crystal Reservoir', riverId: 'gunnison', operator: 'Bureau of Reclamation', latitude: 38.499, longitude: -107.625, maxStorageAcreFt: 25600, normalElevationFt: 6755, sourceId: '1534', source: 'bor-rise', url: 'https://data.usbr.gov/', notes: 'Lowest of the three Aspinall Unit dams. Outflow feeds Gunnison Gorge.', diversionName: 'Gunnison Tunnel', diversionGaugeId: 'usgs-09128000', plannedReleaseUrl: 'https://www.usbr.gov/uc/wcao/water/rsvrs/notice/asp_rel.html', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'taylor-park', name: 'Taylor Park Reservoir', riverId: 'gunnison', operator: 'Bureau of Reclamation', latitude: 38.819, longitude: -106.612, maxStorageAcreFt: 106200, normalElevationFt: 9330, sourceId: '09109000', source: 'usgs', url: 'https://data.usbr.gov/', notes: 'Headwater reservoir on Taylor River. Releases sustain Taylor River kayaking and fishing below dam.', plannedReleaseUrl: 'https://data.usbr.gov/', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'pueblo', name: 'Pueblo Reservoir', riverId: 'arkansas', operator: 'Bureau of Reclamation', latitude: 38.268, longitude: -104.870, maxStorageAcreFt: 357678, normalElevationFt: 4898.7, sourceId: '445', source: 'bor-rise', url: 'https://data.usbr.gov/', notes: 'Key Arkansas River storage. Fryingpan-Arkansas Project. Outflows affect downstream flows but main rafting sections are upstream.', plannedReleaseUrl: 'https://www.usbr.gov/gp/ecao/', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'twin-lakes', name: 'Twin Lakes Reservoir', riverId: 'arkansas', operator: 'Bureau of Reclamation', latitude: 39.078, longitude: -106.363, maxStorageAcreFt: 141000, normalElevationFt: 9210, sourceId: '499', source: 'bor-rise', url: 'https://data.usbr.gov/', notes: 'Fryingpan-Arkansas Project storage on Lake Creek near Leadville. Releases flow into Arkansas River above The Numbers section.', plannedReleaseUrl: 'https://www.usbr.gov/gp/ecao/', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'turquoise-lake', name: 'Turquoise Lake', riverId: 'arkansas', feedsReservoirId: 'twin-lakes', operator: 'Bureau of Reclamation', latitude: 39.261, longitude: -106.386, maxStorageAcreFt: 129440, normalElevationFt: 9868, sourceId: '498', source: 'bor-rise', url: 'https://data.usbr.gov/', notes: 'Fryingpan-Arkansas terminal reservoir near Leadville. Receives transmountain diversions. Releases into Lake Fork Arkansas and into Arkansas via pipeline.', plannedReleaseUrl: 'https://www.usbr.gov/gp/ecao/', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'green-mountain', name: 'Green Mountain Reservoir', riverId: 'blue', operator: 'Bureau of Reclamation', latitude: 39.882, longitude: -106.336, maxStorageAcreFt: 154645, normalElevationFt: 7943, sourceId: '353', source: 'bor-rise', url: 'https://data.usbr.gov/', notes: 'On the Blue River. Colorado-Big Thompson replacement reservoir. Releases affect upper Colorado River near Kremmling.', plannedReleaseUrl: 'https://data.usbr.gov/', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'dillon', name: 'Dillon Reservoir', riverId: 'blue', operator: 'Denver Water', latitude: 39.627, longitude: -106.070, maxStorageAcreFt: 257000, normalElevationFt: 9017, sourceId: '09050700', source: 'usgs', url: 'https://data.usbr.gov/', notes: 'Denver Water supply reservoir on Blue River. Dam-controlled flows sustain Blue River below.', plannedReleaseUrl: 'https://data.usbr.gov/', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'ruedi', name: 'Ruedi Reservoir', riverId: 'roaring-fork', operator: 'Bureau of Reclamation', latitude: 39.356, longitude: -106.819, maxStorageAcreFt: 102000, normalElevationFt: 7766, sourceId: '456', source: 'bor-rise', url: 'https://data.usbr.gov/', notes: 'On Fryingpan River, tributary of Roaring Fork. Fryingpan-Arkansas Project. Releases help sustain Roaring Fork flows.', plannedReleaseUrl: 'https://www.usbr.gov/gp/ecao/', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'mcphee', name: 'McPhee Reservoir', riverId: 'dolores', operator: 'Bureau of Reclamation', latitude: 37.568, longitude: -108.574, maxStorageAcreFt: 381100, normalElevationFt: 6924, sourceId: '09166500', source: 'usgs', url: 'https://data.usbr.gov/', notes: 'Second-largest reservoir in Colorado. Dolores Project. Controls all downstream Dolores River flows — rafting is entirely dependent on release timing and volume. Release measured at USGS 09166500 (Dolores at Dolores); the BOR RISE total-release item read ~5 cfs while the river ran 227, so it is rerouted to the below-dam gauge.', plannedReleaseUrl: 'https://www.doloreswater.com/releases', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'clear-creek-reservoir', name: 'Clear Creek Reservoir', riverId: 'arkansas', operator: 'Bureau of Reclamation (Fryingpan-Arkansas Project)', latitude: 39.022, longitude: -106.27, maxStorageAcreFt: 11500, normalElevationFt: null, sourceId: 'CCBCCRCO', source: 'cdss', url: 'https://dwr.state.co.us/Tools/Stations/CCBCCRCO', notes: 'Fry-Ark augmentation reservoir on Clear Creek; releases enter the Arkansas within the Pine Creek run and travel the whole corridor (Voluntary Flow Management Program).', plannedReleaseUrl: 'https://www.usbr.gov/gp/ecao/', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'lemon', name: 'Lemon Reservoir', riverId: 'florida', operator: 'Bureau of Reclamation (Florida Project)', latitude: 37.39538, longitude: -107.66269, maxStorageAcreFt: 39790, normalElevationFt: null, sourceId: '395', source: 'bor-rise', url: 'https://www.usbr.gov/uc/', notes: 'Controls the Florida River, an Animas tributary joining above the Lower Animas take-out.', plannedReleaseUrl: 'https://www.usbr.gov/uc/', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'granby', name: 'Lake Granby', riverId: 'colorado', operator: 'Bureau of Reclamation / Northern Water (C-BT)', latitude: 40.146, longitude: -105.846, maxStorageAcreFt: 539758, normalElevationFt: null, sourceId: '351', source: 'bor-rise', url: 'https://www.usbr.gov/gp/ecao/', notes: 'Headwater Colorado mainstem control; C-BT operations shape upper Colorado flows.', plannedReleaseUrl: 'https://www.usbr.gov/gp/ecao/', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'williams-fork', name: 'Williams Fork Reservoir', riverId: 'colorado', operator: 'Denver Water', latitude: 39.957, longitude: -106.198, maxStorageAcreFt: 96822, normalElevationFt: null, sourceId: '09038500', source: 'usgs', url: 'https://www.denverwater.org/', notes: 'On the Williams Fork (Colorado tributary, joins at Parshall); fully regulated release measured at USGS below the reservoir.', plannedReleaseUrl: 'https://www.denverwater.org/', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'wolford-mountain', name: 'Wolford Mountain Reservoir', riverId: 'colorado', operator: 'Colorado River District', latitude: 40.121, longitude: -106.337, maxStorageAcreFt: 65985, normalElevationFt: null, sourceId: 'MUDKRECO', source: 'cdss', url: 'https://www.coloradoriverdistrict.org/wolford-mountain-reservoir/', notes: 'On Muddy Creek (Colorado tributary, joins near Kremmling); release reported via CDSS.', plannedReleaseUrl: 'https://www.coloradoriverdistrict.org/wolford-mountain-reservoir/', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'stagecoach', name: 'Stagecoach Reservoir', riverId: 'yampa', operator: 'Upper Yampa Water Conservancy District', latitude: 40.282, longitude: -106.844, maxStorageAcreFt: 33275, normalElevationFt: null, sourceId: '09237500', source: 'usgs', url: 'https://waterdata.usgs.gov/monitoring-location/09237500/', notes: 'On the upper Yampa above Steamboat; tailwater release (and environmental releases) measured at USGS below Stagecoach.', plannedReleaseUrl: 'https://waterdata.usgs.gov/monitoring-location/09237500/', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'elkhead', name: 'Elkhead Reservoir', riverId: 'yampa', operator: 'Colorado River District', latitude: 40.518, longitude: -107.35, maxStorageAcreFt: 25550, normalElevationFt: null, sourceId: 'ELKCRACO', source: 'cdss', url: 'https://www.coloradoriverdistrict.org/', notes: 'On Elkhead Creek (Yampa tributary, joins at Craig); endangered-fish recovery releases sustain lower-Yampa baseflow.', plannedReleaseUrl: 'https://www.coloradoriverdistrict.org/', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'cheesman', name: 'Cheesman Reservoir', riverId: 'south-platte', operator: 'Denver Water', latitude: 39.2077, longitude: -105.2721, maxStorageAcreFt: 79064, normalElevationFt: null, sourceId: '06701500', source: 'usgs', url: 'https://www.denverwater.org/', notes: 'Controls the South Platte through Cheesman Canyon and Deckers; tailwater release at USGS below Cheesman.', plannedReleaseUrl: 'https://www.denverwater.org/', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'strontia', name: 'Strontia Springs Reservoir', riverId: 'south-platte', operator: 'Denver Water', latitude: 39.4347, longitude: -105.1233, maxStorageAcreFt: 7863, normalElevationFt: null, sourceId: 'PLASTRCO', source: 'cdss', url: 'https://www.denverwater.org/', notes: 'At the top of Waterton Canyon; release reported via CDSS (South Platte below Strontia Springs).', plannedReleaseUrl: 'https://www.denverwater.org/', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
	{ id: 'chatfield', name: 'Chatfield Reservoir', riverId: 'south-platte', operator: 'US Army Corps of Engineers', latitude: 39.5472, longitude: -105.065, maxStorageAcreFt: 350000, normalElevationFt: null, sourceId: 'PLACHACO', source: 'cdss', url: 'https://dwr.state.co.us/Tools/Stations/PLACHACO', notes: 'On the South Platte at the Denver metro edge; release reported via CDSS below Chatfield.', plannedReleaseUrl: 'https://dwr.state.co.us/Tools/Stations/PLACHACO', plannedReleaseNote: 'Planned releases are announced by the operator (no live schedule feed).' },
];
...
const ARK_BASELINES: SectionBaseline[] = [
	...
	},
	{
		...
		pushyMax: 3500,
		expertMax: 4500,
		character: 'Class III-IV with Zoom Flume, Pinball, and Seidel\'s Suckhole',
	},
	{
		sectionId: 'arkansas-browns-lower',
		shortName: 'Lower Browns',
		tooLowMax: 349,
		lowRunnableMax: 499,
		idealMin: 700,
		idealMax: 2500,
		pushyMax: 3500,
		expertMax: 4500,
		character: 'Class III-III+ through Staircase to Stone Bridge',
	},
	{
...
// Hand-authored override for the canonical Upper Browns raft+intermediate
// low-runnable band — v1 incorrectly labeled 396 cfs as "too low" here.
const BROWNS_RAFT_INT_LOW = GENERATED_BANDS.find(
	b => b.id === 'arkansas-browns-upper_raft_intermediate_low-runnable',
);
if (BROWNS_RAFT_INT_LOW) {
	...
	BROWNS_RAFT_INT_LOW.authorNote =
		"Upper Browns at this level scrubs but goes — v1 incorrectly labeled this as 'too low'. Private trips run it all season at the low end with a strong crew.";
}
